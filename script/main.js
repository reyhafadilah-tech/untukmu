...
const messages = [
    "Tap dimana aja yaaa",
    "heiii ❤️",
    "aku bisa tebak nama kamuu",
    "percaya gak",
    "pasti nama kamu alika fauziah keyla",
    "bener kan",
    "aku ini peramal",
    "kamu harus percaya sih",
    "kalo aku ada salah sama kamu maafinyawww",
    "i love you",
    ...
    "apa?",
    "apaantat anjay wkwk",
    "jumat jujur cintaku padamu tak akan pernah tamat eak",
    "aku dilan",
    "kuteguk segala badai dan ombakmu tanpa menawar asin juga perihnya.kupelajari luka yang engkau sembunyikan",
    "seperti pelaut yang membaca arah angin sebelum karam.saat kau runtuh",
    "aku memilih menjadi tanah sebagai alas yang sabar,menampung jatuh hingga tempatmu bertumbuh",
